...
[
  {
    ...
    "description": "La protection des données désigne l'ensemble des pratiques et des lois visant à assurer la confidentialité, l'intégrité et la sécurité des informations personnelles. Elle encadre la collecte, le traitement et le stockage des données afin de prévenir leur utilisation non autorisée ou abusive.",
    "doc_ids": null
  },
  {
    "id": "theme_iso",
    "parent_id": null,
    "name": "Thème ISO",
    "description": "Thème ISO utilisés par les SITG",
    "doc_ids": null
  },
  {
    "id": "personal_data",
    ...
    "description": "Les données personnelles sont toute information permettant d'identifier directement ou indirectement une personne physique, comme le nom, l'adresse, l'email ou des données sensibles telles que l'orientation sexuelle ou les données biométriques. Elles sont protégées par des lois visant à garantir leur confidentialité et leur sécurité.",
    "doc_ids": null
  },
  {
    "id": "sensible_data",
  ...
  {
    "id": "pseudonymous_data",
    "parent_id": "data_protection",
    "name": "Données pseudonymisées",
    "description": "Les données pseudonymisées sont des données personnelles qui ont été modifiées de manière à ce qu'elles ne puissent plus être attribuées à une personne spécifique sans informations supplémentaires. Cela permet de réduire les risques pour la vie privée, tout en conservant la possibilité de réidentifier les données si nécessaire, en gardant ces informations complémentaires séparées et protégées.",
    "doc_ids": null
  },
  {
    "id": "anonymous_data",
    ...
    "description": "Les données anonymisées sont des données personnelles qui ont été modifiées de façon irréversible afin qu'elles ne puissent plus être liées à une personne identifiable, directement ou indirectement. Contrairement à la pseudonymisation, l'anonymisation rend impossible la réidentification des individus, même avec des informations supplémentaires.",
    "doc_ids": null
  },
  {
    "id": "developpement_territorial",
    "parent_id": "theme_iso",
  ...
  },
  {
    "id": "cadastre_foncier",
    "parent_id": "theme_iso",
    "name": "Cadastre foncier",
    "description": "Un cadastre est le plan d'un lot inscrit dans un registre dressant l’état de la propriété foncière. Un plan cadastral comporte une vue d'ensemble de cadastres d'une circonscription foncière, d'un territoire foncier ou d'un immeuble détenu en copropriété. Un cadastre peut présenter un lot en : \n\ncadastre horizontal en deux dimensions ;\ncadastre vertical, représenté en trois dimensions (volume), tel un immeuble détenu en copropriété divise comportant un ou des bâtiments.Le terme cadastre s’applique aussi parfois aux systèmes informatisés ayant le même objet, à l’organisation chargée de maintenir ces documents ou systèmes d’information ou même aux travaux de terrain aboutissant à la constitution de ces documents ou systèmes d’information.\nPar extension, le terme cadastre peut impliquer d'autres concepts particuliers: cadastre juridique, cadastre agricole, cadastre solaire, cadastre vert, cadastres des émissions ou des émetteurs de pollution, cadastre fiscal et cadastre des restrictions de droit public à la propriété foncière (cadastre RDPPF).",
    "doc_ids": null
  },
  {
    "id": "foret",
  ...
  },
  {
    ...
    "parent_id": "theme_iso",
    "name": "Ouvrages",
    "description": "Un ouvrage est un « objet résultant d'un travail (plus précisément du travail d'un ouvrier, d'un artisan ou encore d'un artiste, notamment d'un point de vue technique) ». \nCe terme s'applique dans différents domaines.",
    "doc_ids": null
  },
  {
    "id": "altimetrie",
  ...
  },
  {
    ...
    "parent_id": "theme_iso",
    "name": "Hydrographie",
    "description": "L'hydrographie peut être définie de trois manières, selon le contexte :\n\nl'étude et la description des cours d'eau et des étendues d'eau (océans, mers, lacs...) qu'on peut observer à la surface de la terre ou dans le sous-sol (cours d'eau souterrains...) ;\nLe terme désigne aussi l'ensemble des cours d'eau d'une région donnée, organisés en bassins hydrographiques (ou bassin versant) ;\nla topographie maritime ou lacustre qui a pour objet de lever le plan du fond des mers et des fleuves, et de déterminer les diverses profondeurs de l'eau, la force des courants et des marées, dans le but d'établir des cartes marines,",
    "doc_ids": null
  },
  {
    "id": "limites_pol_admin",
    "parent_id": "theme_iso",
    "name": "Limites politiques et administratives",
    "description": "Une région administrative, au Québec, est la première division du territoire après celle de l'État. Le Québec est divisé en 17 régions administratives. Comme leur nom l'indique, il s'agit de divisions administratives et non politiques.\nIl n'existe pas d'instance politique élective responsable de gérer une région et celles-ci ne bénéficient pas de la personnalité morale. Cependant, un ministre responsable, appelé à traiter des enjeux locaux avec le gouvernement provincial ou au nom de ce dernier auprès de la population, est nommé pour chaque région.\nLes régions servent à organiser les services gouvernementaux et le développement du territoire en fonction des particularités régionales. Elles jouent également un rôle identitaire important, les réalités socio-économiques et historiques variant parfois beaucoup en raison de la superficie et de la densité démographique du Québec.\nLes dix premières régions sont créées le 29 mars 1966, puis une réorganisation est faite le 22 décembre 1987.",
    "doc_ids": null
  },
  {
    "id": "atmosphere",
  ...
  },
  {
    ...
    "description": "Un danger est une cause possible de dommage (à une personne, un peuple, un bien, à l'environnement, etc.). La probabilité de survenue de ce dommage est le risque associé à ce danger. On parle évidemment de dangerosité d'une situation ou d'un individu présentant un caractère dangereux.",
    "doc_ids": null
  },
  {
    "id": "transport",
  ...
  },
  {
    ...
    "parent_id": "theme_iso",
    "name": "Population",
    "description": "Une population est un ensemble d'individus ou d'éléments partageant une ou plusieurs caractéristiques qui servent à les regrouper. On parle ainsi de population humaine, statistique, biologique, civile, voire tout simplement de « gens ».",
    "doc_ids": null
  },
  {
    "id": "societe",
  ...
  },
  {
    ...
    "description": "L'approvisionnement est une technique ou méthode permettant de livrer à un tiers un bien ou un service.\nOn peut considérer que l'approvisionnement est distingué en deux flux distincts : physique et administratif (informationnel).\nLe flux administratif est nécessaire à l'envoi et à la réception de données, ordres, commandes, factures, etc. Le flux physique est l'art d'acheminer le bien vers le demandeur, par bateau, avion, camion, chemin de fer, etc.\nL'approvisionnement répond à toutes contraintes environnantes. La règle première est de livrer de la marchandise, au bon moment, au bon prix, et au meilleur coût selon le choix du demandeur.\nLe terme anglais procurement est souvent utilisé pour mettre en évidence une gestion plus fine de l'approvisionnement, selon l'objectif :\n\norienté coût ;\norienté vers la sécurisation de l'approvisionnement.Les exigences sur les approvisionnements se traduisent par le choix de fournisseurs.",
    "doc_ids": null
  },
  {
    "id": "elimination",
    "parent_id": "theme_iso",
    "name": "Élimination",
    "description": "En chimie organique, une élimination (ou β-élimination) est une réaction organique qui transforme un alcane substitué (halogénoalcanes, alcools…) en dérivé éthylénique, voire en alcène, si la molécule de départ, outre le groupe partant, n'est qu'une chaîne carbonée de type alcane.\nLes conditions sont, en plus dures, celles d'une substitution nucléophile, réaction proche par de nombreux aspects et concurrente : l'élimination se produit en présence d'une base forte et en chauffant le mélange réactionnel.",
    "doc_ids": null
  },
  {
    "id": "communication",
    "parent_id": "theme_iso",
    "name": "Communication",
    "description": "Communications est une revue scientifique semestrielle publiée par le Centre Edgar-Morin, qui relève de l'École des hautes études en sciences sociales. Elle est éditée par Le Seuil.",
    "doc_ids": null
  },
  {
    "id": "armee",
  ...
  },
  {
    ...
    "parent_id": "theme_iso",
    "name": "Localisation",
    "description": "En algèbre, la localisation est une des opérations de base de l'algèbre commutative. C'est une méthode qui construit à partir d'un anneau commutatif un nouvel anneau. La construction du corps des fractions est un cas particulier de la localisation.",
    "doc_ids": null
  },
  {
    "id": "systemes_reference",
    "parent_id": "theme_iso",
    "name": "Systèmes de référence",
    "description": "Un système de référence en anatomie désigne la terminologie utilisée pour se repérer de façon précise dans la structure anatomique d'un organisme, humain ou non. Un système de référence anatomique repose sur un ensemble de plans et d'axes définis par rapport à la position standard de l'organisme décrit. Par exemple, on utilise cette terminologie pour indiquer l'orientation des coupes histologiques ou des vues utilisées dans les schémas et images en médecine ou en biologie humaine à partir de la position de Poirier, c'est-à-dire lorsque le sujet est debout face à l'observateur[réf. souhaitée].",
    "doc_ids": null
  },
  {
    "id": "cartes_reference",
    "parent_id": "theme_iso",
    "name": "Cartes de référence",
    "description": "L'expression jeu de cartes désigne à la fois :\nl'ensemble matériel complet des cartes nécessaires pour pratiquer un jeu de société, par exemple un jeu de 32 ou 52 cartes (54 avec les jokers), un jeu de tarot ou un jeu de cartes italien.\nle jeu de société lui-même, s'il utilise comme matériel exclusif, ou pratiquement exclusif, des cartes à jouer traditionnelles ou spécifiques à ce jeu.Dans d'autres domaines, un jeu de cartes peut également désigner un ensemble de cartes géographiques ou un ensemble de cartes perforées pour le traitement mécanographique.",
    "doc_ids": null
  },
  {
    "id": "couverture_sol",
    ...
    "description": "La couverture du sol, aussi appelée occupation du sol, est constituée des matériaux physiques à la surface de la Terre, qu’ils soient naturels ou anthropogéniques, et incluant l’eau, le sol nu, l’herbe, les arbres, le pavage, les constructions, etc.  \nIl existe deux méthodes principales, et complémentaires pour obtenir de l’information sur la couverture du sol : \n\nles enquêtes terrain complétant la cartographie traditionnelle ;\nla télédétection.La nature de la « couverture du sol » est discutée dans Comber et al (2005).",
    "doc_ids": null
  },
  {
    "id": "images_aeriennes",
    ...
    "description": "La photographie aérienne est un domaine vaste tant sur le plan de la variété des documents que des techniques employées.",
    "doc_ids": null
  },
  {
    "id": "images_aeriennes_1",
    "parent_id": "images_aeriennes",
    "name": "Images aériennes sous partie 1",
    "description": null,
    "doc_ids": null
  },
  {
    "id": "images_aeriennes_2",
    "parent_id": "images_aeriennes",
    "name": "Images aériennes sous partie 2",
    "description": null,
    "doc_ids": null
  }
]